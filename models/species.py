...
class Species:
    ...
    @classmethod
    def load_from_dict(cls, dict: dict):
        return cls(
            id=dict.get('id'),
            name=dict.get('name'),
            classification=dict.get('classification'),
            designation=dict.get('designation'),
            average_height=dict.get('average_height'),
            skin_colors=dict.get('skin_colors'),
            hair_colors=dict.get('hair_colors'),
            eye_colors=dict.get('eye_colors'),
            average_lifespan=dict.get('average_lifespan'),
            homeworld=dict.get('homeworld'),
            language=dict.get('language'),
            people=dict.get('people'),
            films=dict.get('films'),
            created=dict.get('created'),
            edited=dict.get('edited'),
            url=dict.get('url'),
        )
