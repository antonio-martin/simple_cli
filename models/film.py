...
class Film:
    ...
    def load_from_api(cls, id: int):
        response = films.get_films(id=id)
    ...
    def load_from_dict(cls, dict: dict):
        return cls(
            episode_id=dict.get('episode_id'),
            title=dict.get('title'),
            opening_crawl=dict.get('opening_crawl'),
            director=dict.get('director'),
            producer=dict.get('producer'),
            release_date=dict.get('release_date'),
            characters=dict.get('_characters'),
            planets=dict.get('planets'),
